...
@section('content')
                                                ...
                                                <div class="border_box">
                                                    ...
                                                    <div id="accordion">
                                                        <div class="card">
                                                            ...
                                                            <div id="target_opt" class="collapse "
                                                                data-parent="#accordion">
                                                                <div class="card-body">
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing
                                                                    elit, sed do eiusmod tempor incididunt ut labore et
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="schedule_cmp" class="collapse"
                                                                data-parent="#accordion">
                                                                <div class="card-body">
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing
                                                                    elit, sed do eiusmod tempor incididunt ut labore et
                                            ...
                                            <div class="border_box">
                                                <div class="int_box">
                                                    ...
                                                    <ul class="integration_list list-unstyled p-0">
                                                        ...
                                                        <li><strong>URL to use:</strong><span
                                                                class="url">https://lorem.ipsum/dolor/sit-amet</span>
                                                        </li>
    ...
    <!-- Modal Filter leads -->
    <div class="modal fade create_sequence_modal filter_modal" id="filter_modal" tabindex="-1"
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="row">
                            ...
                            <a href="javascript:;" class="crt_btn ">Apply filters<i
