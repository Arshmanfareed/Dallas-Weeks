        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-12">
                ...
                <div class="border_box">
                    <div class="chart_box">
                        <div class="d-flex justify-content-between">
                            <span>Campaign stats</span><a href="javascript:;"><img src="{{ asset('assets/img/settings.svg') }}" alt=""></a>
                        </div>
                    ...
                    <div class="invite_date_box">
                        @for ($i = 0; $i <= 3; $i++) <ul class="date d-flex list-unstyle">
                            <li>
                                <span>Date</span>
                                2023-01-16
                            </li>
            ...
            <div class="col-lg-7 col-sm-12">
                    ...
                    <div class="campaign_box">
                        ...
                        <div class="campaign_data">
                            ...
                            <div class="campaign_list" style="display: block">
                                <div class="text-center text-danger" style="font-size: 22px; font-weight: bold; font-style: italic;">
                                    Campaign Not Found!
                                </div>
                            </div>
                            @endif
                ...
                <div class="border_box">
                    <div class="campaign_box">
                        <div class="d-flex justify-content-between">
                            <span>Messages</span><a href="javascript:;"><img src="{{ asset('assets/img/settings.svg') }}" alt=""></a>
                        </div>
                        <div class="campaign_data">
                            @for ($i = 0; $i < 7; $i++) @php $asset_id=$i + 1; $asset='assets/img/acc_img' . $asset_id . '.png' ; @endphp <ul class="message_list">
